...
const Index = () => {
  ...
  const handleSearch = async (event) => {
    ...
    const [res, err] = await roleService.search(name, sort, page);
    if (res) {
      setApiData(res.data.data);
  ...
  const handlePageChange = async (page) => {
    ...
    setCurrentPage(page);
    const [res, err] = await roleService.search(null, "Id-DESC", page);
    if (res) {
      setApiData(res.data.data);
      setTotalPages(res.data.totalPages);
    } else {
  ...
  const handleDelete = async (id) => {
    ...
    if (result.isConfirmed) {
      const [res, err] = await roleService.remove(id);
      if (res) {
            ...
            <div class="iq-card">
              <div class="iq-card-header d-flex justify-content-between">
                ...
                <div class="iq-card-header-toolbar d-flex align-items-center">
                  <Link to={"/admin/role/create"} className="btn btn-primary">
                    Add role
                  </Link>
                </div>
              </div>
